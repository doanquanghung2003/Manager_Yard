...
public class DashboardController implements BaseController {
	...
	private void deleteYard(YardModel yard) {
		...
		singleton.DuLieu.getInstance().saveYardToFile("data/yards.json");
	}
	...
	private void deleteBooking(BookingModel booking) {
		...
		singleton.DuLieu.getInstance().saveBookingToFile("data/bookings.json");
	}
	...
	private void deleteService(bean.ServicesModel service) {
		...
		singleton.DuLieu.getInstance().saveServiceToFile("data/services.json");
	}
	...
	private void deleteUser(bean.UserModel user) {
		...
		singleton.DuLieu.getInstance().saveUserToFile("data/users.json");
	}
